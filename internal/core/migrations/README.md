...
- **`0011_collab_spaces.sql`** *（来自 `zpc001/feat/collab-spaces` 的协作空间迁移，前移重编号到 Issues 序列之后；**schema 语义待 D1/D2 决策，不可视为定稿**）*：协作空间（产品术语 Workspace）Schema：
...
- **`0012_project_space_scope.sql`** *（见 0011 —— **语义待 D1/D2 决策**）*：Project 空间作用域与数据回填：
