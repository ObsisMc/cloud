...
/**
 * Workspace settings. Cloud sessions edit the real space name (slug stays
 * immutable) with the optimistic version guard; owners additionally get an
 * archive action in a danger zone. Mock sessions keep the demo store
 * rendering.
 */
