...
export function AgentDetailPage({ slug }: { slug: string }) {
  ...
  if (isPending || !agent) {
    return (
      <div className="flex h-full flex-col">
        <PageHeader title="智能体" breadcrumb={{ label: '智能体', to: p.agents }} />
  ...
  return (
    <div className="flex h-full flex-col">
      <PageHeader title={agent.name} breadcrumb={{ label: '智能体', to: p.agents }} />
        ...
        <div className="mb-6 flex items-start gap-3">
          ...
          <div>
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <Badge variant="outline">{AGENT_STATUS_LABELS[agent.status]}</Badge>
