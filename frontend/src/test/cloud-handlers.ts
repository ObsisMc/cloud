 ...
 * tenant list, one space whose slug is `cloud-dev`, and a credential session.
 * Tests install them with {@link installCloudSpaceHandlers} and sign the tab
 * in with {@link setCloudCredentials}.
 */
...
export const TEST_CLOUD_CREDENTIALS = {
